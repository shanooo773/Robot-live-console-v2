          ...
          <div className="feedback-track">
            ...
            <div className="feedback-card">
              <div className="client-image">
                <img src="/saif.jpeg" alt="M. Saifullah Saeed" />
              </div>
            ...
            <div className="feedback-card">
              <div className="client-image">
                <img src="/tabarak.jpeg" alt="Tabarak Rehman Chaudhary" />
              </div>
            ...
            <div className="feedback-card">
              <div className="client-image">
                <img src="/shahzaib.jpeg" alt="Shahzaib" />
              </div>
            ...
            <div className="feedback-card">
              <div className="client-image">
                <img src="/haseeb.jpeg" alt="Haseeb Shaukat" />
              </div>
            ...
            <div className="feedback-card">
              <div className="client-image">
                <img src="/laiq.jpeg" alt="Muhammad Bin Laiq" />
              </div>
